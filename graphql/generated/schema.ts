...
export type FileState = 'ERROR' | 'GENERATED_UPLOAD_URL' | 'PENDING' | 'READY' | 'UPLOADED_TO_CLOUD_STORAGE' | 'UPLOADED_TO_IPFS'
...
export type ListingState = 'ACTIVE' | 'HIDE_FROM_STORE' | 'INACTIVE' | 'NOT_AVAILAIBLE_FOR_PURCHASE' | 'SHOW_IN_STORE' | 'SOLD'
...
export type NFTBlockchainState = 'ERROR' | 'MINTED' | 'MINTING' | 'TRANSFERRED' | 'TRANSFERRING' | 'UNMINTED'
...
export type SaleProcessingState = 'AVAILABLE' | 'CREATED' | 'ERROR' | 'LOCKED' | 'RESERVED' | 'SOLD' | 'TRANSFERRING'
...
export type WalletState = 'CREATION_FAILED' | 'PENDING_CREATION' | 'READY' | 'UNVERIFIED' | 'VERIFIED'
...
export interface MutationGenqlSelection{
    ...
    appId?: (Scalars['ID'] | null), data?: (CreateNiftoryWalletInput | null), 
