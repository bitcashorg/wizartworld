...
import { useFlowAuthContext } from '~/context/flow-auth.context'

import type { GraphQLQuery, GraphQLQueryType } from './types'
...
export function useGraphQLQuery<Outputs extends Record<string, unknown>, Variables = any>(
  opts: GraphQLQueryOpts<Outputs, any>,
): any {
  const { isLoading } = useFlowAuthContext()
