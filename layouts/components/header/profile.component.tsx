...
import { defaultProfile, useAuthContext } from '~/context/auth.context'
      ...
      <div className="grid">
        <label htmlFor="name">
          ...
          <input
            ...
            onChange={(e) => setProfile({ ...editedProfile, name: e.target.value })}
          />
        </label>
        ...
        <label htmlFor="color">
          ...
          <input
            ...
            onChange={(e) => setProfile({ ...editedProfile, color: e.target.value })}
          />
        </label>
      </div>
